  ...
  <html lang="en">
    <head>
      ...
      <title>
        ...
        else echo "Rixe Stock v.1.0.2 - El asistente virtual para tu negocio -- By Ciro.";?>
      </title>
    ...
    <body>
      <?php if ($session->isUserLoggedIn(true)): ?>
        <header id="header">
          <div class="logo pull-left"> Rixe Stock v1.0.2 </div>
          <div class="header-content">
          <div class="header-date pull-left">
            <strong>
            Rixe Stock v.1.0.2 - El asistente virtual para tu negocio -- By Ciro.. &nbsp;&nbsp;
